...
public class Instituto {
    ...
    public void cargarAlumnos() {
        try (ObjectInputStream in =
                     new ObjectInputStream(new FileInputStream("ficheros/gestion_alixar.txt"))) {
    ...
    public void guardarAlumnos() {
        try (ObjectOutputStream out =
                     new ObjectOutputStream(new FileOutputStream("ficheros/gestion_alixar.txt"))) {
